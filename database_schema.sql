...
INSERT INTO `carrito` VALUES (2,1,1,1,'2025-10-26 19:47:33');
...
CREATE TABLE `detalles_pedido` (
  ...
  CONSTRAINT `detalles_pedido_ibfk_2` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`id`) ON DELETE RESTRICT
...
CREATE TABLE `productos` (
  ...
  `valoracion_conteo` int DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `productos` VALUES (1,'Teclado Gay','Teclado funcional para todos los jugadores ',1200.00,2,'68fe70033574a_1761505283.jpg','Perifericos ','redDragon','Gamer','teclado','',5.00,1);
...
CREATE TABLE `reseñas` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `producto_id` (`producto_id`,`usuario_id`),
  KEY `usuario_id` (`usuario_id`),
...
INSERT INTO `reseñas` VALUES (1,1,1,5,'hola es muy bueno y me gusto ','2025-10-26 19:39:23');
...
INSERT INTO `usuarios` VALUES (1,'daniel ','labrada','hola@gmail.com','$2y$10$pT9LsH9dV2lQPlpZRkhqzOVB6zHFJrUCwuLGl/m4ig5uW6gojudQW','2025-10-26 18:27:01');
...
-- Dump completed on 2025-11-04 12:21:37
